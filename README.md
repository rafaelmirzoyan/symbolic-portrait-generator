...
The project ... how pixels of image can be mapped to symbols using ... library ... 
Therefore, using the technique behind pixel mapping, the following 

# Possible Extensions
Visual Cryptography: Extend the symbolic mapping toward asymmetric encryption, allowing visual information to be encoded and decrypted using cryptographic keys.
